...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {PmodBT1_RTS}];  # "JA1"
##set_property PACKAGE_PIN AA8  [get_ports {}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {PmodBT1_RX}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {PmodBT1_TX}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {PmodBT1_CTS}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {PmodBT1_STATUS}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {PmodBT1_nRST}];  # "JA8"
##set_property PACKAGE_PIN AB9  [get_ports {}];  # "JA9"

#set_property PACKAGE_PIN Y11  [get_ports {PmodBT2_A_RTS}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {PmodBT2_A_RXD}];  # "JA2"
#set_property PACKAGE_PIN Y10  [get_ports {PmodBT2_A_TXD}];  # "JA3"
#set_property PACKAGE_PIN AA9  [get_ports {PmodBT2_A_CTS}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {PmodBT2_A_STATUS}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {PmodBT2_A_nRST}];  # "JA8"
#set_property PACKAGE_PIN AB9  [get_ports {PmodBT2_}];  # "JA9"
#set_property PACKAGE_PIN AA8  [get_ports {PMODA_o[1]}];  # "JA10"

#set_property PACKAGE_PIN Y11  [get_ports {PmodBT2_A_RTS}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {UART0_TX_directlyToPmodA_RX}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {UART0_RX_directlyFromPmodA_TX}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {PMOD_A_CTS}];  # "JA4"
#set_property PACKAGE_PIN AB11 [get_ports {PmodBT2_A_STATUS}];  # "JA7"
#set_property PACKAGE_PIN AB10 [get_ports {PmodBT2_A_nRST}];  # "JA8"
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN W12 [get_ports {PmodBT2_B_RTS}];  # "JB1"
#set_property PACKAGE_PIN W11 [get_ports {PmodBT2_B_RXD}];  # "JB2"
#set_property PACKAGE_PIN V10 [get_ports {PmodBT2_B_TXD}];  # "JB3"
#set_property PACKAGE_PIN W8  [get_ports {PmodBT2_B_CTS}];  # "JB4"
#set_property PACKAGE_PIN V12 [get_ports {PmodBT2_B_STATUS}];  # "JB7"
#set_property PACKAGE_PIN W10 [get_ports {PmodBT2_B_nRST}];  # "JB8"
